...
alert(value)
  ...
  return (
    <Layout style={{ padding: '20px' , height:"100vh" , position:"absolute", top:"0%" , bottom:"0%", right:"0%",left:"0%", background:"black", opacity:"0.9", boxSizing:"border-box" , overflow:"auto" , height:"auto"}}>
      <Content style={{ fontFamily: '"DM Sans", sans-serif', color: textColor , opacity:"1" }}>
        <p style={{color:"white" , fontSize:"30px" , float:"right" , cursor:"pointer"}} onClick={()=>toggleClicked()}>&times;</p>
